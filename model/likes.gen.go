...
type Like struct {
	...
	UserID    int64          `gorm:"column:user_id;type:bigint(20) unsigned;comment:点赞用户id" json:"user_id"`                 // 点赞用户id
	VideoID   int64          `gorm:"column:video_id;type:bigint(20) unsigned;comment:点赞视频id" json:"video_id"`               // 点赞视频id
