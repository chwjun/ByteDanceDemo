...
func newLike(db *gorm.DB, opts ...gen.DOOption) like {
	...
	_like.Liked = field.NewInt64(tableName, "liked")
...
type like struct {
	...
	VideoID   field.Int64 // 点赞视频id
	Liked     field.Int64 // 默认1表示已点赞，0表示未点赞
...
func (l *like) updateTableName(table string) *like {
	...
	l.Liked = field.NewInt64(table, "liked")
