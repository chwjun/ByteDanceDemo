...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.ActionType = field.NewString(tableName, "action_type")
...
type comment struct {
	...
	UserID     field.Int64  // 发布评论的用户id
	VideoID    field.Int64  // 评论视频的id
	Content    field.String // 评论的内容
	ActionType field.String // 评论行为，1表示已发布评论，2表示删除评论
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.ActionType = field.NewString(table, "action_type")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["action_type"] = c.ActionType
}
